...
- «Таблицы БД» — явное включение и исключение реальных таблиц сайта для каждого
  профиля, с поиском, числом строк и размером;
...
- «История» — результат запусков, а dry-run до создания архива показывает состав
  таблиц, число обезличиваемых столбцов и таблицы, которые будут очищены.
