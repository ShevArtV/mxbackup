...
$_lang['mxbackup_invalid_json']='Invalid JSON.'; $_lang['mxbackup_builtin_profile_remove']='Built-in prod and dev profiles cannot be removed.';
...
$_lang['setting_mxbackup.config_path'] = 'Additional settings file';
$_lang['setting_mxbackup.config_path_desc'] = 'Optional PHP file with mxBackup settings. Enter an absolute path; values from the file override this tab and database profiles. When empty, mxBackup checks core/config/mxbackup.php and uses the manager settings if that file does not exist.';
