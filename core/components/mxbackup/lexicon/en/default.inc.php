...
// Remote archive storage (1.4.0-rc)
$_lang['mxbackup_remote'] = 'Remote storage';
$_lang['mxbackup_remote_short'] = 'Cloud';
$_lang['mxbackup_remote_off'] = 'disabled';
$_lang['mxbackup_remote_driver'] = 'Storage';
$_lang['mxbackup_remote_driver_desc'] = 'Where to upload the archive once it is created. Disabled — the copy stays on this server only.';
$_lang['mxbackup_remote_s3_bucket'] = 'Bucket';
$_lang['mxbackup_remote_s3_region'] = 'Region';
$_lang['mxbackup_remote_s3_region_desc'] = 'For example eu-central-1. It is part of the request signature: a wrong one yields SignatureDoesNotMatch.';
$_lang['mxbackup_remote_s3_prefix'] = 'Key prefix';
$_lang['mxbackup_remote_s3_prefix_desc'] = 'Folder inside the bucket, e.g. stage/. Empty — store in the root.';
$_lang['mxbackup_remote_s3_endpoint'] = 'Endpoint';
$_lang['mxbackup_remote_s3_endpoint_desc'] = 'For S3-compatible storages (MinIO, Selectel, Yandex). Empty — Amazon S3.';
$_lang['mxbackup_remote_s3_storage_class'] = 'Storage class';
$_lang['mxbackup_remote_s3_storage_class_desc'] = 'STANDARD_IA, GLACIER_IR and alike. Empty — the bucket default.';
$_lang['mxbackup_remote_s3_access_key'] = 'Access key';
$_lang['mxbackup_remote_s3_access_key_desc'] = 'Leave both fields empty when access comes from an instance role or environment variables — then no keys are stored on the server at all.';
$_lang['mxbackup_remote_s3_secret_key'] = 'Secret key';
$_lang['mxbackup_remote_s3_secret_desc'] = 'Stored in the profile file with 0640 permissions. Never shown back.';
$_lang['mxbackup_remote_s3_secret_keep_desc'] = 'A key is set. Leave the field empty to keep it.';
$_lang['mxbackup_remote_keep_local'] = 'Copies on disk';
$_lang['mxbackup_remote_keep_local_desc'] = 'How many recent archives to keep on the server after a successful upload. Minimum 1: the latest copy must not depend on the cloud being reachable.';
$_lang['mxbackup_remote_retention_days'] = 'Keep in cloud, days';
$_lang['mxbackup_remote_retention_desc'] = '0 in both fields — delete nothing: let the storage itself manage depth (bucket lifecycle rule).';
$_lang['mxbackup_remote_retention_count'] = 'Keep in cloud, archives';
